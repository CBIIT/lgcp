...
sce <- read10xCounts("/Volumes/Group05/CCBB/CS024892_Kelly_Beshiri/02_PrimaryAnalysisOutput/00_FullCellrangerOutputs/SCAF731_190328_G18/outs/filtered_feature_bc_matrix/")
...
save(sce_glm_pca, file = "/Volumes/Group05/CCBB/Single-Cell-Bioinformatics-2019-October-03/lucap145.2-sce-object.Rdata")
